...
if a==1:
    ...
    def date(d):
        if d == 'No Order':
            ...
            return (f'{storage_sand[2].year}-0{storage_sand[2].month}-{storage_sand[2].day}')


    def date_time(var):
        return (f'{storage_cement[2].year}-{storage_cement[2].month}-{storage_cement[2].day}')
    while True:
        inpu = int(input("1. Cement's Order\n2. Brick's Order\n3. Sand Order\n4. Exit\nEnter the Choice: "))
        if inpu == 1:
